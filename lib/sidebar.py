...
####################################################################################
# We create the necessary elements that allow filtering the information
####################################################################################
...
drowpdown_state = dcc.Dropdown(
    id='Drowpdown_state',
    options=[{'label': i, 'value': i} for i in ['Activo', 'Egresado','Inactivo']],
    placeholder="Select .."
